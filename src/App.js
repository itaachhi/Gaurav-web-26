...
function App() {
  ...
  const getApidata = async () => {
    const options = {
      ...
      headers: {
        'X-RapidAPI-Key': 'fbc2186936mshfb4d66e4c556a63p17d82djsnf556a56e7762',
  ...
  return (
    ...
    <div className="container bg-gray-100">
      ...
      <a href='https://appopener.co.in/ig/pb09wycyv' target='_blank' rel='noreferrer' className='flex gap-2 flex-row justify-center items-center'>
